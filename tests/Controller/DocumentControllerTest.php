...
final class DocumentControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'document[fichier]' => 'Testing',
            'document[dateupload]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDateupload('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'document[fichier]' => 'Something New',
            'document[dateupload]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDateupload());
    }
